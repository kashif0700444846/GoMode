...
#
#  (1) This script is generated by the Gradle 'wrapper' task.
#
#  (2) This script is designed to be used with a Gradle wrapper jar.
#
##############################################################################
...
if [ -n "$JAVA_HOME" ] ; then
    if [ -x "$JAVA_HOME/bin/java" ] ; then
        # Others might emit warnings about the use of JAVA_HOME
...
if [ "$cygwin" = "true" -o "$msys" = "true" ] ; then
    ...
    # JAVA_HOME_W=`cygpath --path --windows "$JAVA_HOME"`
